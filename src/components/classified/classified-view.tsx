...
const features = (props: ClassifiedWithImagesAndMake) => [
  ...
  },
  {
    id: 2,
    icon: (
      <Fingerprint className="w-6 h-6 mx-auto text-gray-500 hover:text-gray-700" />
    ),
    label: props.vrm,
  },
  {
    id: 3,
    icon: (
      <CarIcon className="w-6 h-6 mx-auto text-gray-500 hover:text-gray-700" />
    ),
  ...
  },
  {
    id: 4,
    icon: (
      <FuelIcon className="w-6 h-6 mx-auto text-gray-500 hover:text-gray-700" />
    ),
  ...
  },
  {
    id: 5,
    icon: (
      <PowerIcon className="w-6 h-6 mx-auto text-gray-500 hover:text-red-700" />
    ),
  ...
  },
  {
    id: 6,
    icon: (
      <GaugeIcon className="w-6 h-6 mx-auto text-gray-500 hover:text-gray-700" />
    ),
  ...
  },
  {
    id: 7,
    icon: (
      <UsersIcon className="w-6 h-6 mx-auto text-gray-500 hover:text-gray-700" />
    ),
    label: props.seats,
  },
  {
    id: 8,
    icon: (
      <CarFrontIcon className="w-6 h-6 mx-auto text-gray-500 hover:text-gray-700" />
    ),
    label: props.doors,
  },
];
        ...
        <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {features(props).map(({ id, icon, label }) => (
              <div
                key={id}
                className="bg-gray-100 hover:bg-gray-200 rounded-lg shadow-xs p-4 text-center flex items-center flex-col"
              >
                {icon}
